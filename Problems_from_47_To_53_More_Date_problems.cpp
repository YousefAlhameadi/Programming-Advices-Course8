...
bool IsEndOfWeek(string NameOfDay)
{
    return (NameOfDay == "Sat") ? true: false;
}
...
bool IsBusinessDay(string NameOfDay)
{
    return !IsWeekend(NameOfDay) ? true : false;
}
...
short HowManyDaysUntilTheEndofWeek(stDate TodaysDate)
{
...
int main()
{
    ...
    short indexOfTodaysDate = IndexOfDay(TodaysDate);

    cout << "Today is " << WeekDays(indexOfTodaysDate) << " , " << TodaysDate.Day << " / " << TodaysDate.Month << " / " << TodaysDate.Year;

    cout << endl;

    cout << endl << "Is it End of Week ? " << endl;

    if (IsEndOfWeek(WeekDays(indexOfTodaysDate)))
    {
        cout << "yes it is " << endl;
    }
    else
    ...
    if (IsWeekend(WeekDays(indexOfTodaysDate)))
    {
        cout << "yes it is " << endl;
    }
    else
    ...
    if (IsBusinessDay(WeekDays(indexOfTodaysDate)))
    {
        cout << "yes it is " << endl;
    }
    else
